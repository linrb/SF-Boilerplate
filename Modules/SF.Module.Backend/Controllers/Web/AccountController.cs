    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new UserEntity { UserName = model.Email, Email = model.Email, DisplayName = model.FullName };
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                await _emailSender.SendSecurityCodeEmailAsync(_siteContext, await _userManager.GetEmailAsync(user), "Security Code", code);
            }
